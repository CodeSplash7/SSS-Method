...
export default function Navbar() {
  ...
  return (
    <div
      className={`bg-[#111111] w-full h-[76px] px-[48px] flex items-center gap-[32px]`}
    >
      {links.map((l, index) => (
        <Link
          key={index}
          ...
          } hover:text-[#1cbac8] transition duration-150 text-[13px] text-white font-bold ${font_roboto_700}`}
          href={l[1]}
        >
          {l[0]}
        </Link>
