    ...
    >
        <div
            className={`col-start-1 col-end-3 row-start-1 row-end-2 sm:col-start-2 sm:col-end-3
                                    w-full flex flex-col items-center justify-center flex flex-col gap-[12px] px-[12px] py-[8px] bg-white/50 rounded-[6px] sm:p-[8px]`}
        >
            <div
...
const PathSlideButton = ({ direction }: { direction: "left" | "right" }) => {
    return (
        <div
            className={`bg-${direction === "left" ? "white" : "[#D30C7B]"} w-[16px] h-[16px] flex items-center justify-center p-[4px] rounded-[3px]  sm:bg-transparent sm:w-[54px] sm:h-[68px] sm:p-[16px]`}
        >
            <svg
